...
<head>
  ...
  <script>
    // Inicialización del tema — evita el flash blanco al cargar en modo oscuro
    (function () {
      const savedTheme = localStorage.getItem('nutriai_theme') || 'light';
...
<body data-theme="light">
  ...
  <script>
    ...
    function handleGoogleCredential(response) {
      ...
      const payload = { credential: response.credential, biometricData: wizardState };
      ...
      .then(data => {
         if(data.status === 'success') {
            ...
            showToast('Hubo un problema registrando tus datos físicos', 'error');
