...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-06-2026 a las 22:24:47
...
('0d1e2f3a-4b5c-6d7e-8f9a-0b1c2d3e4f5a', NULL, 'Omelette de Queso', 'Keto', 'Desayuno o cena exprés, bajo en carbohidratos. ~10 min.', '1. Batir huevos. 2. Volcar en sartén caliente. 3. Agregar queso y jamón, doblar.', 1, '🍳'),
...
('2b3c4d5e-6f7a-8b9c-0d1e-2f3a4b5c6d7e', NULL, 'Batido de Frutos', 'Vegetariana', 'Smoothie fresco de frutos rojos. ~5 min.', '1. Licuar leche, frutillas y arándanos. 2. Servir frío.', 1, '🍓'),
...
('4d5e6f7a-8b9c-0d1e-2f3a-4b5c6d7e8f9a', NULL, 'Tostadas Francesas', 'Vegetariana', 'Desayuno dulce y proteico. ~15 min.', '1. Batir huevo y leche. 2. Remojar pan. 3. Dorar en sartén y servir con miel.', 1, '🍞'),
('5e6f7a8b-9c0d-1e2f-3a4b-5c6d7e8f9a0b', NULL, 'Ensalada Caprese', 'Vegetariana', 'Clásica ensalada italiana, fresca y ligera. ~10 min.', '1. Cortar tomate y queso en rodajas. 2. Alternar con hojas de albahaca. 3. Aliñar con oliva.', 2, '🥗'),
...
('7a8b9c0d-1e2f-3a4b-5c6d-7e8f9a0b1c2d', NULL, 'Ceviche de Merluza', 'Sin Gluten', 'Pescado marinado en limón. Fresco y sin cocción. ~20 min.', '1. Cortar pescado en cubos. 2. Macerar en limón 15 min. 3. Agregar cebolla y cilantro.', 2, '🐟'),
...
('9c0d1e2f-3a4b-5c6d-7e8f-9a0b1c2d3e4f', NULL, 'Pudding de Chía', 'Vegana', 'Postre o merienda que se prepara solo en la heladera.', '1. Mezclar chía y leche. 2. Refrigerar 4 horas. 3. Servir con mango picado.', 1, '🍮'),
('a0c3f4d5-6e7f-8a9b-0c1d-2e3f4a5b6c7d', NULL, 'Muffins de Huevo', 'Vegetariana', 'Desayuno o snack proteico al horno. ~25 min.', '1. Batir huevos. 2. Picar espinaca. 3. Mezclar con queso, poner en moldes y hornear 20 min.', 2, '🧁'),
('a1b2c3d4-e5f6-a7b8-c9d0-e1f2a3b4c5d6', NULL, 'Lasaña Berenjena', 'Keto', 'Lasaña low-carb usando láminas de berenjena. ~45 min.', '1. Cortar berenjena en láminas. 2. Intercalar con carne, salsa y queso en fuente. 3. Hornear.', 4, '🍆'),
('a1c9b5d2-8e2f-46a7-bd4c-9e1f5a2b8d3c', NULL, 'Frutas con yogur', 'Vegetariana', 'Postre dulce y saludable. Frutas y yogur. ~5 min.', '1. Cortar frutas. 2. Mezclar con yogur.', 1, '🍦'),
...
('a8c1b9d5-8e2f-46a7-bd4c-9e1f5a2b8d3c', NULL, 'Ensalada garbanzos', 'Vegana', 'Plato fresco, salado y proteico. ~15 min.', '1. Cocinar garbanzos. 2. Cortar vegetales. 3. Mezclar y aliñar.', 2, '🥗'),
('a9c5b1d8-8e2f-46a7-bd4c-9e1f5a2b8d3c', NULL, 'Tostadas con palta', 'Vegana', 'Desayuno salado con grasas saludables. ~5 min.', '1. Tostar pan. 2. Pisar palta. 3. Untar y servir.', 1, '🥑'),
('b1d4a5e6-7f8a-9b0c-1d2e-3f4a5b6c7d8e', NULL, 'Sopa de Calabaza', 'Vegetariana', 'Clásica sopa de zapallo, cremosa y reconfortante. ~30 min.', '1. Hervir zapallo y cebolla. 2. Licuar todo. 3. Calentar agregando un toque de crema.', 2, '🥣'),
('b1d8f5a2-9c3e-46b7-a4d1-2e8c5f9b3a7d', NULL, 'Espinaca y nueces', 'Keto', 'Ensalada salada con grasas saludables. ~10 min.', '1. Lavar espinaca. 2. Agregar nueces y queso. 3. Mezclar.', 2, '🥜'),
('b2c3d4e5-f6a7-b8c9-d0e1-f2a3b4c5d6e7', NULL, 'Helado de Banana', 'Vegetariana', 'Helado cremoso de un solo ingrediente base. ~5 min.', '1. Congelar banana en rodajas. 2. Licuar con yogur y mantequilla de maní hasta cremar.', 2, '🍨'),
('b2d5f8a1-7c9e-43a6-9b1d-4e8c2f5a7b3d', NULL, 'Yogur con chía', 'Vegetariana', 'Snack dulce, rico en omega 3. Yogur, chía y frutas. ~5 min.', '1. Mezclar yogur con chía. 2. Agregar frutas.', 1, '🥣'),
('b4f1c9d2-8e3a-4a7b-9c6d-2f5e8b1a4c3f', NULL, 'Brownies Chocolate', 'Vegetariana', 'Clásicos brownies húmedos y llenos de sabor a cacao. ~45 min.', '1. Derretir chocolate con mantequilla. 2. Mezclar harina. 3. Hornear a 180°C por 25 min.', 4, '🍫'),
('b5d1f8a2-9c3e-46b7-a4d1-2e8c5f9b3a7d', NULL, 'Panqueques de avena', 'Vegetariana', 'Desayuno dulce y fit. Avena, huevo y leche. ~15 min.', '1. Mezclar ingredientes. 2. Cocinar en sartén.', 2, '🥞'),
('b8d1f5a9-9c3e-46b7-a4d1-2e8c5f9b3a7d', NULL, 'Lentejas guisadas', 'Vegana', 'Plato caliente, alto en proteína vegetal. ~30 min.', '1. Hervir lentejas. 2. Saltear vegetales. 3. Mezclar y cocinar.', 3, '🍲'),
('b9d8f1a5-9c3e-46b7-a4d1-2e8c5f9b3a7d', NULL, 'Wok de camarones', 'Sin Gluten', 'Comida asiática fit. Camarones, fideos de arroz y vegetales.', '1. Hervir fideos. 2. Saltear camarones y vegetales. 3. Integrar.', 2, '🍤'),
('c1e9d5a4-4b9f-48c3-8a1e-7d6f9b2c5a4d', NULL, 'Batido de chocolate', 'Vegetariana', 'Shake alto en proteína. Leche, whey, cacao y banana.', '1. Poner todo en licuadora. 2. Licuar hasta espumar.', 1, '🍫'),
('c2d5f8e1-3e5b-48a6-bd4e-9c1f7a2b5d8e', NULL, 'Crema Champiñones', 'Keto', 'Sopa cremosa y reconfortante de champiñones frescos. ~30 min.', '1. Picar cebolla y champiñones. 2. Sofreír 10 min. 3. Licuar con crema y calentar sin hervir.', 2, '🍲'),
('c2e5b6f7-8a9b-0c1d-2e3f-4a5b6c7d8e9f', NULL, 'Galletas de Avena', 'Vegana', 'Galletas dulces sin harina, solo 3 ingredientes. ~20 min.', '1. Pisar banana y mezclar con avena. 2. Agregar chips de chocolate. 3. Formar galletas y hornear 15 min.', 3, '🍪'),
('c3e5d2a1-4b9f-48c3-8a1e-7d6f9b2c5a4d', NULL, 'Bowl arroz y salmón', 'Sin Gluten', 'Plato completo, balanceado. Arroz, salmón y brócoli.', '1. Cocinar arroz. 2. Plancha el salmón. 3. Hervir brócoli.', 2, '🍣'),
('c5e1a8d4-9b2f-47c3-8a6e-1d5f9b2c4a7d', NULL, 'Tortilla de papa fit', 'Sin Gluten', 'Plato salado, clásico adaptado. Papa y huevo. ~20 min.', '1. Cocinar papa. 2. Mezclar con huevo. 3. Cocinar en sartén.', 2, '🍳'),
('c7e2d5a1-4b9f-48c3-8a1e-7d6f9b2c5a4d', NULL, 'Ensalada atún', 'Sin Gluten', 'Baja en calorías, salada. Atún, lechuga y tomate. ~10 min.', '1. Mezclar todos los ingredientes. 2. Aliñar.', 1, '🐟'),
('c9e4d1a5-4b9f-48c3-8a1e-7d6f9b2c5a4d', NULL, 'Avena con frutas', 'Vegetariana', 'Desayuno dulce, energético. Avena, leche y frutas.', '1. Cocinar avena con leche. 2. Agregar frutas. 3. Mezclar.', 1, '🥣'),
('d1a9c4b8-2e9f-45d3-8b6a-1c5e9f2d4a7b', NULL, 'Pollo con batata', 'Sin Gluten', 'Plato salado, clásico fitness. Pollo y batata. ~30 min.', '1. Cortar batata. 2. Condimentar pollo. 3. Hornear ambos 25 min.', 2, '🍠'),
('d3f6c7a8-9b0c-1d2e-3f4a-5b6c7d8e9f0a', NULL, 'Risotto de Quinoa', 'Vegetariana', 'Alternativa rica en proteínas al clásico risotto. ~25 min.', '1. Saltear cebolla y champiñones. 2. Agregar quinoa y agua de a poco. 3. Finalizar con queso.', 2, '🥘'),
('d4a7c1b8-2e9f-45d3-8b6a-1c5e9f2d4a7b', NULL, 'Ensalada de pollo', 'Sin Gluten', 'Ensalada salada, fresca y rica en proteínas.', '1. Cocinar pechuga. 2. Cortar en cubos. 3. Mezclar con vegetales.', 2, '🥗'),
...
('d8a1c9b4-2e9f-45d3-8b6a-1c5e9f2d4a7b', NULL, 'Porridge de manzana', 'Vegetariana', 'Desayuno reconfortante. Avena caliente con manzana y miel.', '1. Cocinar avena con leche. 2. Añadir manzana en cubos y miel.', 1, '🍎'),
('d9a1c4b7-2e8f-45d3-8b6a-1c5e9f2d4a7b', NULL, 'Salteado de tofu', 'Vegana', 'Plato vegano, salado. Incluye tofu, brócoli y zanahoria. ~20 min.', '1. Cortar tofu. 2. Saltear verduras. 3. Agregar tofu y cocinar.', 2, '🍱'),
('e1f4a8d2-9b3c-47e5-a6d1-5b2c8f9a3d7e', NULL, 'Pollo con quinoa', 'Sin Gluten', 'Plato completo, salado. Pollo, quinoa y vegetales. ~25 min.', '1. Cocinar quinoa. 2. Cocinar pollo. 3. Mezclar con verduras.', 2, '🥗'),
('e2f8a1d5-9b3c-47e5-a6d1-5b2c8f9a3d7e', NULL, 'Batido verde detox', 'Vegana', 'Bebida ligera, refrescante. Espinaca, manzana y pepino. ~5 min.', '1. Licuar todos los ingredientes.', 1, '🥦'),
('e4b29c1d-8f3a-4a7b-9c6d-2f5e8b1a4c3d', NULL, 'Hummus con vegetales', 'Vegana', 'Snack salado, cremoso. Garbanzos y aceite de oliva. ~10 min.', '1. Procesar garbanzos. 2. Servir con zanahoria en bastones.', 2, '🥕'),
('e5f1a8d2-9b3c-47e5-a6d1-5b2c8f9a3d7e', NULL, 'Yogur con granola', 'Vegetariana', 'Snack dulce, nutritivo. Yogur, granola y frutas.', '1. Colocar yogur en bowl. 2. Agregar granola y frutas.', 1, '🥣'),
('e8a1d2b3-4c5d-6e7f-8a9b-0c1d2e3f4a5b', NULL, 'Pizza de Avena', 'Vegetariana', 'Base de avena crujiente, ideal para cenas ligeras. ~20 min.', '1. Licuar avena y huevo. 2. Cocinar base en sartén. 3. Agregar salsa y queso, tapar hasta derretir.', 1, '🍕'),
('e8f2a5d1-9b3c-47e5-a6d1-5b2c8f9a3d7e', NULL, 'Arroz con atún', 'Sin Gluten', 'Plato simple, salado y proteico. Arroz y atún. ~15 min.', '1. Cocinar arroz. 2. Mezclar con atún y aceite.', 1, '🍚'),
('f1a5b8c9-1d5e-47a6-9c4b-8e1f2d5a7b3c', NULL, 'Ensalada de quinoa', 'Vegana', 'Plato fresco, salado y rico en fibra. Quinoa y vegetales.', '1. Cocinar quinoa. 2. Cortar vegetales. 3. Mezclar.', 2, '🥗'),
('f2a8b3c9-1d5e-47a6-9c4b-8e1f2d5a7b3c', NULL, 'Bowl de frutas', 'Vegana', 'Preparación dulce, refrescante. Incluye frutas variadas. ~5 min.', '1. Cortar frutas. 2. Mezclar en bowl.', 1, '🍓'),
('f5a1b8c9-1d5e-47a6-9c4b-8e1f2d5a7b3c', NULL, 'Merluza y espárragos', 'Keto', 'Plato keto/low carb. Pescado magro y espárragos salteados.', '1. Sellar espárragos con oliva. 2. Cocinar merluza a la plancha.', 2, '🐟'),
('f8b3c1a2-5d7e-49b6-a4c2-8e1f5d9b3a7c', NULL, 'Smoothie de banana', 'Vegetariana', 'Bebida dulce, ideal post-entreno.', '1. Colocar ingredientes en licuadora. 2. Licuar.', 1, '🥤'),
('f9a2b8c3-1d5e-47a6-9c4b-8e1f2d5a7b3c', NULL, 'Omelette de espinaca', 'Keto', 'Desayuno salado, alto en proteínas. Huevo y espinaca.', '1. Batir huevos. 2. Agregar espinaca. 3. Cocinar en sartén.', 1, '🥬'),
('f9b2e3c4-5d6e-7f8a-9b0c-1d2e3f4a5b6c', NULL, 'Tacos de Lechuga', 'Keto', 'Opción low-carb fresca. Relleno de carne magra. ~15 min.', '1. Saltear carne con cebolla y tomate. 2. Lavar hojas de lechuga. 3. Rellenar las hojas como tacos.', 2, '🌮');
